...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    date: "2024-01-15",
    type: "feature",
    description: "Complete overhaul of the blog with a fresh new design, improved performance, and new features.",
    changes: [
  ...
  },
  {
    ...
    date: "2024-01-08",
    type: "feature",
    description: "Added powerful search and filtering capabilities to help readers find content faster.",
    changes: [
  ...
  },
  {
    ...
    date: "2023-12-10",
    type: "breaking",
    description: "Breaking changes to the API structure for better consistency.",
    changes: [
  ...
  },
  {
    ...
    date: "2023-12-01",
    type: "feature",
    description: "Added a dedicated page to showcase personal projects and work.",
    changes: [
